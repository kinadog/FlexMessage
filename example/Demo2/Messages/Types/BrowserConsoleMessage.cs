...
public class BrowserConsoleMessage : IMessage
{
    ...
    public BrowserConsoleMessage(IHttpContextAccessor contextAccessor)
    {
    ...
    public void Write(string? message)
    {
        ...
        if (getConnectionId && !string.IsNullOrWhiteSpace(connectionId))
        {
            ...
            _hubContext!.Clients.Client(connectionId!).SendAsync("ReceiveMessage", "BrowserConsole", message);
        }
    }
    ...
    public async Task WriteAsync(string? message)
    {
        ...
        {
            connectionId = Hashing.Decrypt(connectionId);
            await _hubContext!.Clients.Client(connectionId!).SendAsync("ReceiveMessage", "BrowserConsole", message);
        }
    }
